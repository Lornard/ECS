...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS_ALT",		"+2 de [ICON_GOLD] Ouro na [ICON_CAPITAL] Capital e em cada edificação de Mercado ou Farol."		),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",			"+2 de [ICON_GOLD] Ouro na [ICON_CAPITAL] Capital e em cada edificação de Mercado."						),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",		"+4 de [ICON_GOLD] Ouro em cada edificação de Banco, Estaleiro e Consulado."		),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",			"+4 de [ICON_GOLD] Ouro em cada edificação de Banco e Consulado."						),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",		"+6 de [ICON_GOLD] Ouro em cada edificação de Bolsa de Valores, Porto Marítmo e Chancelaria."			),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",			"+6 de [ICON_GOLD] Ouro em cada edificação de Bolsa de Valores e Chancelaria."						),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",		"+2 de [ICON_GOLD] Ouro em cada edificação do Centro Comercial, Porto e da Área Diplomática."	),
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",			"+2 de [ICON_GOLD] Ouro em cada edificação do Centro Comercial e da Área Diplomática."				),
