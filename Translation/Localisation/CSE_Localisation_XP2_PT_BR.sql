...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de primeiro nível do Plaza Governamental."	),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_LARGE_INFLUENCE_BONUS",			"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de segundo nível do Plaza Governamental."	),
	("pt_BR",	"LOC_CSE_CONSULAR_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_FAVOR] Favor Diplomático em qualquer edificação de terceiro nível do Plaza Governamental."	),
